      ...
      >
        <div className="sticky top-0 left-0 w-full h-screen overflow-hidden">
          ...
          >
            ...
            <spotLight position={[-5, 5, 5]} intensity={1.5} color="#00ffff" angle={0.3} penumbra={1} castShadow />
            <spotLight position={[5, -5, 5]} intensity={1.2} color="#ff00ff" angle={0.3} penumbra={1} castShadow />
